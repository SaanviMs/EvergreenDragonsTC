...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 139200.0183377812; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -184814.68045324812; // x position of the perpendicular encoder (in tick units)
    }
